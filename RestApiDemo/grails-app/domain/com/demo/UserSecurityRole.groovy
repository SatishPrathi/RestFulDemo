...
class UserSecurityRole implements Serializable {
    ...
    static UserSecurityRole create(AppUser user, SecurityRole securityRole, boolean flush = false) {
    ...
    static constraints = {
        user nullable: false
        securityRole nullable: false, validator: { SecurityRole r, UserSecurityRole ur ->
            if (ur.user?.id) {
